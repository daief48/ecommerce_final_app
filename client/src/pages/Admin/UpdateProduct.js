  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const { data } = axios.put(
        `https://ecommerce-final-app-backend.onrender.com/api/v1/product/update-product/${id}`,
        productData
      );
      if (data?.success) {
  ...
  const handleDelete = async () => {
    try {
      ...
      const { data } = await axios.delete(
        `https://ecommerce-final-app-backend.onrender.com/api/v1/product/product/${id}`
      );
            ...
            <div className="m-1 w-75">
              ...
              <div className="mb-3">
                {photo ? (
                  ...
                  <div className="text-center">
                    <img
                      src={`https://ecommerce-final-app-backend.onrender.com/api/v1/product/product-photo/${id}`}
                      alt="product_photo"
                      height={"200px"}
                      className="img img-responsive"
                    />
